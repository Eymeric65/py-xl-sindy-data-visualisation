...
\node (s6) [below=of s5.west,anchor=west] {6. Combine the mixed SINDy solution};
...
\node(ln) [below=1.5cm of instructions.south west,anchor=west,sindy component,full opacity,fill=sindystandard,label=right:{: \small non-null cordinate/function data}] {};
...
\matrix[matrix of nodes,
        ...
        right delimiter={]},
        nodes in empty cells
        ] (m3) [left=1cm of instructions.west, anchor=east,yshift=-0.8cm] {
