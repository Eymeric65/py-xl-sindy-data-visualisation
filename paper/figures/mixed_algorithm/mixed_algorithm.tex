...
\node (s1)  {1. Find coordinate actived by pre-knowledge};
\node (s2a) [below=of s1.west,anchor=west] {2.a Find coordinates and function activated};
\node (s2b) [below=of s2a.west,anchor=west] {2.b Recursively find until no new activations};
\node (s3) [below=of s2b.west,anchor=west] {3. Execute explicit SINDy};
\node (s4) [below=of s3.west,anchor=west] {4. Find every function and coordinate not activated by the explicit solution};
\node (s5) [below=of s4.west,anchor=west] {5. Execute implicit SINDy on the remaining components};
\node (s6) [below=of s5.west,anchor=west] {6. Finalize the mixed SINDy solution};
\node (final) [below=of s6.west,anchor=west] {Final solution :\tiny $S =$};
%
...
\matrix[matrix of nodes,
        ...
        right delimiter={]},
        nodes in empty cells
        ] (m2b) [left=1cm of instructions.west, anchor=east] {
...
\matrix[matrix of nodes,
        ...
        right delimiter={]},
        nodes in empty cells
        ] (m3) [right=1cm of instructions.east, anchor=west] {
        |[fill=sindystandard,full opacity]| & |[full opacity]| & |[full opacity]| & |[fill=sindystandard,full opacity]| & |[full opacity]| & |[full opacity]| & |[full opacity]| & |[full opacity]| & |[fill=sindystandard,full opacity]| \\
